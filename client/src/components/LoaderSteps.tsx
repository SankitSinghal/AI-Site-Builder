...
const LoaderSteps = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
        ...
        {/*Step level - fade using transition only (no visible start) */}
        <p key={current} className='mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700 ease-in-out opacity-800'>
